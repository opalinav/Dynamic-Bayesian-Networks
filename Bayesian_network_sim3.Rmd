...
score<-function(bootstrap, mat){
  ...
  for(i in 1:nrow(bootstrap['strength'])) {
    ...
    sum_edges<-sum_edges+edgestrength*abs(strength-edge)
    sum_dirs<-sum_dirs+edgestrength*abs(dir-direct)
  }
  N<-dim(mat)[1]
...
dat2<-Linstep(M1,dat1,5)

dat3<-Linstep(M1,dat1,10)
